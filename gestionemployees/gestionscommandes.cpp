...
#include "ui_gestionscommandes.h"
#include "commandes.h"
#include <QMessageBox>
#include <QTranslator>
...
gestionscommandes::gestionscommandes(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gestionscommandes)
{
    ui->setupUi(this);
...
gestionscommandes::~gestionscommandes()
{
    delete ui;
}
/*
void gestionscommandes::on_checkBox_clicked()
{

}

*/
void gestionscommandes::on_pushButton_3_clicked()//click sur le boutton ajouter
{
...
/*
void gestionscommandes::on_checkBox_stateChanged(int arg1)
{

}
*/

void gestionscommandes::on_pushButton_5_clicked()//appuie sur le boutton supprimer
{
...
void gestionscommandes::on_tableView_activated(const QModelIndex &index)
{

}

void gestionscommandes::on_tableView_doubleClicked(const QModelIndex &index)//lorque double click sur l'index d'une commande dans le tableau
{
...
void gestionscommandes::on_pushButton_clicked()//appuie sur le boutton modifier
{
...
void gestionscommandes::on_Boutton_Afiche_Commades_clicked()//Boutton Afficher Commandes pour se deplacer dans la partie afficher Commandes
{
    ui->stackedWidget->setCurrentIndex(1);
}

void gestionscommandes::on_Boutton_aller_a_ajouterCommande_clicked()
{
    ui->comboBox->setModel(Etmp.remplirComboBoxClient());//remplir la comboBox Client sur la page ajouter
    ui->comboBox_5->setModel(Etmp.remplirComboBoxEmploye());//remplir la comboBox Employe sur la page ajouter
    ui->comboBox_4->setModel(Etmp.remplirComboBoxEmploye());//remplir la comboBox Employe sur la page Modifier
...
void gestionscommandes::on_comboBox_4_activated(int index)
{
    QSqlQuery query;
...
void gestionscommandes::on_tableWidget_2_cellChanged(int row, int column)
{
    //calcule des prix
...
/*
void gestionscommandes::on_tableWidget_2_itemChanged(QTableWidgetItem *item)
{

}
*/

void gestionscommandes::on_checkBox_8_stateChanged(int arg1)//etat du checkbox montant croissant change
{
...
void gestionscommandes::on_checkBox_9_stateChanged(int arg1)//etat du checkbox montant decroissant change
{
    bool montantCroissant=ui->checkBox_8->isChecked();
    bool montantDecroissant=ui->checkBox_9->isChecked();
    bool dateDepotCroissant=ui->checkBox_10->isChecked();
...
void gestionscommandes::on_checkBox_10_stateChanged(int arg1)//etat du checkbox datedepot croissant change
{
    bool montantCroissant=ui->checkBox_8->isChecked();
    bool montantDecroissant=ui->checkBox_9->isChecked();
    bool dateDepotCroissant=ui->checkBox_10->isChecked();
...
void gestionscommandes::on_checkBox_11_stateChanged(int arg1)//etat du checkbox datedepot decroissant change
{
    bool montantCroissant=ui->checkBox_8->isChecked();
    bool montantDecroissant=ui->checkBox_9->isChecked();
    bool dateDepotCroissant=ui->checkBox_10->isChecked();
...
void gestionscommandes::on_checkBox_12_stateChanged(int arg1)//etat du checkbox dateRetrait croissant change
{
    bool montantCroissant=ui->checkBox_8->isChecked();
    bool montantDecroissant=ui->checkBox_9->isChecked();
    bool dateDepotCroissant=ui->checkBox_10->isChecked();
...
void gestionscommandes::on_checkBox_13_stateChanged(int arg1)//etat du checkbox dateRetrait decroissant change
{
    bool montantCroissant=ui->checkBox_8->isChecked();
    bool montantDecroissant=ui->checkBox_9->isChecked();
    bool dateDepotCroissant=ui->checkBox_10->isChecked();
...
void gestionscommandes::on_checkBox_14_stateChanged(int arg1)//etat du checkbox nbpieces croissant change
{
    bool montantCroissant=ui->checkBox_8->isChecked();
    bool montantDecroissant=ui->checkBox_9->isChecked();
    bool dateDepotCroissant=ui->checkBox_10->isChecked();
...
void gestionscommandes::on_checkBox_15_stateChanged(int arg1)
{
    bool montantCroissant=ui->checkBox_8->isChecked();
    bool montantDecroissant=ui->checkBox_9->isChecked();
    bool dateDepotCroissant=ui->checkBox_10->isChecked();
...
void gestionscommandes::on_lineEdit_4_textChanged(const QString &arg1)
{
...
void gestionscommandes::on_checkBox_3_stateChanged(int arg1)//l'etat de la case livrable change
{
...
void gestionscommandes::on_checkBox_16_stateChanged(int arg1)//l'etat de la case nonlivrable change
{
    bool livrable=ui->checkBox_3->isChecked();
    bool nonLivrable=ui->checkBox_16->isChecked();
    bool paye=ui->checkBox_4->isChecked();
...
void gestionscommandes::on_checkBox_4_stateChanged(int arg1)//l'etat de la case paye change
{
    bool livrable=ui->checkBox_3->isChecked();
    bool nonLivrable=ui->checkBox_16->isChecked();
    bool paye=ui->checkBox_4->isChecked();
...
void gestionscommandes::on_checkBox_7_stateChanged(int arg1)//l'etat de la case nonPaye change
{
    bool livrable=ui->checkBox_3->isChecked();
    bool nonLivrable=ui->checkBox_16->isChecked();
    bool paye=ui->checkBox_4->isChecked();
...
void gestionscommandes::on_pushButton_2_clicked()//Pour calculer le total
{
    QString temp;
...
void gestionscommandes::on_pushButton_10_clicked()//Clique sur le boutton Pour envoyer un SMS au client pour qu'il vienne retirer sa commande
{
    //recuperer l'identifiant de la commande
    QModelIndex index= ui->tableView->currentIndex();
    QString data= ui->tableView->model()->data(index).toString();
...
void gestionscommandes::on_pushButton_11_clicked()//Clique sur le boutton Definir Langue
{
    bool ok;
    QTranslator Langue;
...
void gestionscommandes::on_pushButton_12_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}


/*void gestionscommandes::update_label()//Mise a jour de la partie "Attribuer des Points de Fidelite" Quand des donnes sont recu de la carte Arduino
{
...
void gestionscommandes::on_pushButton_9_clicked()//Pour aller a la partie "afficher les commandes" apartir de "attribuer point de fidelite"
{
    ui->stackedWidget->setCurrentIndex(1);
}

void gestionscommandes::on_pushButton_13_clicked()//Pour aller a la partie "ajouter une nouvelle commande" apartir de "attribuer point de fidelite"
{
    ui->stackedWidget->setCurrentIndex(0);
}

void gestionscommandes::on_pushButton_14_clicked()//Pour aller a la partie "attribuer point de fidelite" apartir de "ajouter une nouvelle commande"
{
    ui->stackedWidget->setCurrentIndex(3);
}

void gestionscommandes::on_pushButton_15_clicked()//Pour aller a la partie "attribuer point de fidelite" apartir de "ajouter une nouvelle commande"
{
    ui->stackedWidget->setCurrentIndex(3);
}

/*void gestionscommandes::on_pushButton_8_clicked()
{
    QSqlQuery query;
