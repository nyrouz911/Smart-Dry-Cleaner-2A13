...
void produits::on_pushButton_2_clicked()
{
    QString  fournisseur,type_machine,image ;
        int id_produit,quantite,prix_unitaire;
...
void produits::on_pushButton_3_clicked()
...
void produits::on_tableView_doubleClicked(const QModelIndex &index)
{
...
void produits::on_lineEdit_textChanged(const QString &arg1)
{
     ui->tableView->setModel(tmpproduit.recherche(arg1));
}


void produits::on_lineEdit_2_textChanged(const QString &arg1)
{
     ui->tableView->setModel(tmpproduit.recherchefournisseur(arg1));
}

void produits::on_lineEdit_3_textChanged(const QString &arg1)
{
     ui->tableView->setModel(tmpproduit.recherchequantite(arg1));
}

void produits::on_lineEdit_4_textChanged(const QString &arg1)
{
    ui->tableView->setModel(tmpproduit.rechercheprix(arg1));
}

void produits::on_lineEdit_5_textChanged(const QString &arg1)
{
...
void produits::on_pushButton_5_clicked()
{
...
/* void produits::on_pushButton_61_clicked()+
{
...
/*void produits::on_pushButton_8_clicked()
{
        QString plan;
...
void produits::on_pushButton_6_clicked()
{
     ui->tableView->setModel(tmpproduit.AfficherTriquantite());
}

void produits::on_pushButton_7_clicked()
{
  ui->tableView->setModel(tmpproduit.AfficherTriID());
}
void produits::on_pushButton_4_clicked()
{
...
void produits::on_comboBox_activated(const QString &arg1)
{
...
void produits::on_lineEdit_6_textChanged(const QString &arg1)
{
